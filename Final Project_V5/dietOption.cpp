...
void setDietGoal(const string& username) {
    system(CLEAR); //  Clear the console first

    int choice;
    cout << "\033[1;36m"; // Cyan color
    cout << setw(110) << "=================== SET DIET GOAL ===================\n\n";
    cout << "\033[0m";

    cout << setw(90) << "1. Gain Weight (Calorie Surplus)\n";
    cout << setw(78) << "2. Maintain Weight\n";
    cout << setw(90) << "3. Lose Weight (Calorie Deficit)\n\n";
    cout << setw(90) << "0. Go Back\n";
    cout << setw(77) << "Enter your choice: ";
    cin >> choice;
    ...
    switch (choice) {
        ...
        default:
            cout << "\033[1;31m" << setw(77) << "Invalid choice.\n" << "\033[0m";
            cout << "\nPress Enter to continue...";
        	cin.ignore();
        	cin.get();
        	system(CLEAR);
    ...
    system(CLEAR); // ? Clear again for clean output
    ...
    if (file.is_open()) {
        ...
        cout << setw(60) << "Diet goal set to '" << goal << "' successfully!\n";
        cout << "\033[0m";
    } else {
        cout << "\033[1;31m" << setw(50) << "Error saving diet goal.\n" << "\033[0m";
        return;
    }
    ...
    if (!users.is_open()) {
        cout << "\033[1;31m" << setw(50) << "Error: users.txt not found.\n" << "\033[0m";
        return;
    }
    ...
    if (!in.is_open()) {
        cout << "\033[1;31m" << setw(45) << "Error: Cannot find profile file to update BMR.\n" << "\033[0m";
        return;
    }
    ...
    cout << "\n";
    if (updated)
        cout << "\033[1;33m" << setw(60)
             << "Profile updated with adjusted BMR (" << adjusted << " kcal/day)!\n" << "\033[0m";
    else
        cout << "\033[1;31m" << setw(50) << "Warning: BMR line not found in profile file.\n" << "\033[0m";
        
    cout << "\n\n";
	cout << "\033[1;37m" << setw(75) << "Press Enter to return to the main menu...";
    cout << "\033[0m";
    cin.ignore();
